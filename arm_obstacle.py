...
class TM5MController:
    ...
    def _build_pose_goal_msg(self, x, y, z, qx, qy, qz, qw, yaw):#OMPL 大範圍移動輔助函數
        ...
        req.max_velocity_scaling_factor, req.max_acceleration_scaling_factor = 0.8, 0.8
        ...
        bv = BoundingVolume()
        bv.primitives.append(SolidPrimitive(type=SolidPrimitive.SPHERE, dimensions=[0.01])) # 誤差範圍 0.1 公分
        ...
        ori_con.absolute_x_axis_tolerance = ori_con.absolute_y_axis_tolerance = ori_con.absolute_z_axis_tolerance = 0.08
        ori_con.weight = 1.0
...
class TM5MTaskNode(Node):
    ...
    def _move_to_initial(self):
        self.is_moving = True
        #target_radians = [math.radians(deg) for deg in [25.0, -30.0, 105.0, -35.0, 65.0, 15.0]]
        ...
        self.arm.go_to_joints(target_radians, velocity=0.3, accel=0.5, done_cb = self.on_action_completed)
