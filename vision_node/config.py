...
_MODEL_PATH_BY_MODE = {
    ...
    'isaac': '/home/terry/Desktop/stem_isaac_train/runs/segment/tomato_stem/exp3/weights/best.pt',
}
...
# --- 果梗骨架化 / 抓取點 -----------------------------------------------------
GRASP_TARGET_DIST_M = 0.015           # 抓取點目標離果實端(calyx)的實際距離 (m)，果梗夠長時優先用這個
GRASP_RATIO_MIN = 0.2                # 果梗太短、量不到目標距離時，退回比例保底下限 (沿路徑從果實端算起)
GRASP_RATIO_MAX = 0.3                # 退回比例保底上限
