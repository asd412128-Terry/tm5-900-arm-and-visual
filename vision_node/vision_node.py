...
from .config import (ARM_FLANGE_FRAME, CAMERA_EXTRINSIC_ROTATION_QUAT,
                      ...
                      WORLD_FRAME, YOLO_CONF, YOLO_IMGSZ)
...
class VisionNode(Node):
    ...
    def color_callback(self, msg):  
        ...
        results = self.detector.predict(cv_image, YOLO_IMGSZ, YOLO_CONF)
    ...
    def auto_pick_thread(self):
        ...
        valid = self.target_selector.build_valid_candidates(targets, self.latest_tomatoes)
        if not valid:
